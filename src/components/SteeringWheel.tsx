...
export const SteeringWheel: React.FC<SteeringWheelProps> = ({ props }) => {
    ...
    props.eventBus.getStream(DataHoverEvent).subscribe((data) => { setTime(data.payload.point.time) })
    ...
    const deegree = view.get(nearestIndex)[1];
    ...
    return (<div>
        <svg height={height} width={width}
            ...
            <path fill={"hsl(" + (120 - Math.abs(deegree)) + ", 100%, 50%)"}
